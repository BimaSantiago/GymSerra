...
const Nosotros = () => {
  ...
  const valores = [
    ...
    },
    {
      ...
      icono: <Sparkles className="h-8 w-8 text-green-500" />,
    },
  ];
      ...
      <SubSeccion title="Nuestros Valores Corporativos">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
          {valores.map((valor, index) => (
            <div
              key={index}
              className="bg-white rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 p-6 border border-gray-100 flex flex-col items-center text-center"
            >
